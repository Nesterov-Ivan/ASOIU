...
namespace connect_DB
{
    public partial class Form1 : Form
    {
        ...
        {
            string connectionString = @"Data Source=АЛЕКСАНДР-ПК\SQLEXPRESS;Initial Catalog=mybase;Integrated Security=True";
        ...
        {
            MessageBox.Show("Maks petuh", "Info", MessageBoxButtons.OK, MessageBoxIcon.Error);
        }
    }
}
